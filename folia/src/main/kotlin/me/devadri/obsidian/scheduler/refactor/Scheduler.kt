...
interface Scheduler {
    ...
    fun runLaterAsync(unit: TimeUnit, delay: Long, func: (ScheduledTask) -> Unit): ScheduledTask

    fun runTimer(unit: TimeUnit, delay: Long, period: Long, func: (ScheduledTask) -> Unit): ScheduledTask

    fun runTimerAsync(unit: TimeUnit, delay: Long, period: Long, func: (ScheduledTask) -> Unit): ScheduledTask
